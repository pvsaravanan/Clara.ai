...
RUN mkdir -p /home/clara-ai/data
RUN yarn build
...
COPY --from=builder /home/clara-ai/public ./public
COPY --from=builder /home/clara-ai/.next/static ./public/_next/static
COPY --from=builder /home/clara-ai/.next/standalone ./
COPY --from=builder /home/clara-ai/data ./data
COPY drizzle ./drizzle

RUN mkdir /home/clara-ai/uploads
...
CMD ["/home/clara-ai/entrypoint.sh"]
